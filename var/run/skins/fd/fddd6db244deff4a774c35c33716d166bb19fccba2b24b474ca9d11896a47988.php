...
class __TwigTemplate_673d5c799e6ee7ac800110b69c302d7f2b4683c2c92fc148236aed800354f37b extends \XLite\Core\Templating\Twig\Template
{
...
<ul class=\"menu menu-tree{% if not this.isSubtree() %} catalog-categories catalog-categories-tree{% endif %}\">
  ...
  {% for idx, _category in this.getCategories(this.rootId) %}
    <li {{ this.displayItemClass(idx, loop.length, _category)|raw }}>
      <a href=\"{{ url('category', '', {'category_id': _category.id}) }}\" {{ this.displayLinkClass(idx, loop.length, _category)|raw }}>{{ _category.name }}</a>
...
", "categories/tree/body.twig", "D:\\openserver\\domains\\xcart\\skins\\customer\\categories\\tree\\body.twig");
    }
}
