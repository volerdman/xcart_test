...
class __TwigTemplate_bbe41eb9b14b801efd8a143272e8de5779c96f505ca6b98517dfde39f0dc322a extends \XLite\Core\Templating\Twig\Template
{
  ...
  <div class=\"carousel-inner not-initialized\" role=\"listbox\">
    {% for image in this.getImages() %}
      <a {% if image.bannerRotationSlide.getFrontLink() %} href=\"{{ image.bannerRotationSlide.getFrontLink() }}\"{% endif %} class=\"item\">
        {{ widget('\\\\XLite\\\\View\\\\Image', lazyLoad=true, image=image, alt=image.getAlt(), resizeImage=false, useCache=false) }}
      </a>
    {% endfor %}
  </div>
</div>
", "banner_rotation/body.twig", "D:\\openserver\\domains\\xcart\\skins\\customer\\banner_rotation\\body.twig");
    }
}
