...
class __TwigTemplate_856974f5921f86051975dbecb1472e006cf43363785b90b9250be4236a951c8a extends \XLite\Core\Templating\Twig\Template
{
...
";
 ...
 # Orders link
 #
 # @ListChild (list=\"slidebar.navbar.account\", weight=\"10\")
 #}

{% if this.isLogged() %}
\t<li>
\t\t<a class=\"icon-orders\" href=\"{{ url('order_list', '') }}\">
\t\t\t<span>{{ t('Orders') }}</span>
\t\t</a>
\t</li>
{% endif %}
", "layout/header/mobile_header_parts/navbar/account/orders.twig", "D:\\openserver\\domains\\xcart\\skins\\crisp_white\\customer\\layout\\header\\mobile_header_parts\\navbar\\account\\orders.twig");
    }
}
