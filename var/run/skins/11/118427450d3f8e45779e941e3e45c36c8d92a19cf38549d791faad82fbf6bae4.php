...
class __TwigTemplate_fbb541955ebcaf3048b8e1f3522541285c7d46d547ff490be4b81d60e2cd0ef2 extends \XLite\Core\Templating\Twig\Template
{
...
{% if this.doCSSAggregation() and this.doCSSOptimization() %}
  {% for file in this.getAggregateCSSResources() %}
    ...
    <script>
      var xhr = new XMLHttpRequest();
      xhr.open('GET', '{{ this.getResourceURL(file.url, file) }}');
      xhr.send('');
    </script>
    {% endif %}
  {% endfor %}
{% endif %}
", "footer/parts/css_aggregation.twig", "D:\\openserver\\domains\\xcart\\skins\\customer\\footer\\parts\\css_aggregation.twig");
    }
}
